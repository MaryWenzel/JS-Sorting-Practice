...
const stringsToNumbs = strNums.map((i) => Number(i));
...
const sumEvens = (stringsToNumbs) => {
  ...
  for (let i = 0; i < stringsToNumbs.length; i++) {
    if (stringsToNumbs[i] % 2 === 0) {
      sum += stringsToNumbs[i]
    }
  }
  return sum
}

console.log("Sum of even numbers:", sumEvens(stringsToNumbs));
...
// ----------------------------------------------------------------
// Method 1)
// let getWeather = (weather) => weather.weather_state_name
// const weatherStates = weather.map(getWeather)

// console.log('Values for weather_state_name:' , weatherStates)
// ----------------------------------------------------------------
...
// const minTemp = (arr) =>{
//   let id = (id) => id.id
//   const filterTemp = arr.filter(weather => weather.min_temp === 15.915)
//   return filterTemp.map(id)
// }

// console.log (minTemp(weather))
// ----------------------------------------------------------------

// ----------------------------------------------------------------
// Method 2)
const minTemp = weather.filter(temp => {return temp.min_temp === 15.915})

console.log('ID with min-temp of 15.915:', minTemp[0].id)